...
CREATE TABLE `endtime` (
  ...
  PRIMARY KEY (`ProID`)
) ENGINE=InnoDB AUTO_INCREMENT=2129 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-01-04 18:41:08
