...
INSERT INTO `autobid` VALUES (10,2109,NULL,50,'Long Hồ'),(11,2091,NULL,12345,NULL),(11,2108,NULL,100,'Trà Long');
...
CREATE TABLE `endtime` (
  ...
  PRIMARY KEY (`ProID`)
) ENGINE=InnoDB AUTO_INCREMENT=2110 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `feedback` VALUES (1,'hiihihihh',11,25,2107),(2,'shop lua dao',11,25,2107),(3,'234',11,10,2091);
...
INSERT INTO `request` VALUES (21,11,'qqq','hi admin');
...
INSERT INTO `userpoint` VALUES (1,0,0),(2,0,0),(3,0,0),(22,0,0),(23,1,2),(24,0,0),(25,8,3);
...
INSERT INTO `wishlist` VALUES (1,11,'2091'),(2,10,'2092'),(3,11,'2092'),(4,11,'2094'),(5,10,'2092'),(6,10,'2094'),(7,11,'2096'),(8,11,'2096'),(9,11,'2097'),(10,11,'2097'),(11,10,'2097'),(12,11,'2092'),(13,11,'2105'),(14,11,'2105'),(15,11,'2105'),(16,11,'2106'),(17,10,'2106');
...
-- Dump completed on 2019-12-30 19:56:46
